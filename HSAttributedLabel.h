...
@class UIColor, NSAttributedString, NSDataDetector, NSTextCheckingResult, NSDictionary, NSString, NSArray;
@protocol HSAttributedLabelDelegate;

@protocol HSAttributedLabel <NSObject>
@property(copy, nonatomic) id text;
@end

@interface HSAttributedLabel : XXUnknownSuperclass <HSAttributedLabel, UIGestureRecognizerDelegate> {
	...
	id<HSAttributedLabelDelegate> _delegate;
...
@property(assign, nonatomic) id<HSAttributedLabelDelegate> delegate;
