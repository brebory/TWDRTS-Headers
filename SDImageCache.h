...
@class NSCache, NSString, NSFileManager, NSMutableArray, NSObject;
...
-(void)clearDisk;
-(void)clearMemory;
-(void)removeImageForKey:(id)key fromDisk:(BOOL)disk withCompletition:(id)completition;
-(void)removeImageForKey:(id)key fromDisk:(BOOL)disk;
-(void)removeImageForKey:(id)key withCompletition:(id)completition;
