...
@interface BITKeychainUtils : XXUnknownSuperclass {
}
+(BOOL)purgeItemsForServiceName:(id)serviceName error:(id*)error;
+(BOOL)deleteItemForUsername:(id)username andServiceName:(id)name error:(id*)error;
+(BOOL)storeUsername:(id)username andPassword:(id)password forServiceName:(id)serviceName updateExisting:(BOOL)existing accessibility:(void*)accessibility error:(id*)error;
